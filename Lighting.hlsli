...
// While all of this code can be placed at the bottom of Lighting.hlsli, these two
// constants could be at the top (right under the definition of PI).  Up to you!
